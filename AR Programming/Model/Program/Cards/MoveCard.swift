...
struct MoveCard: StatementCard {
    ...
    let description = "Når robotten ser dette kort, vil den tage ét skridt frem i den retning den kigger i. Brug rotationskortene til at ændre robottens retning. Hvis robotten skal gå længere frem så brug dette kort flere gange."
